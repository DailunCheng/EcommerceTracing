...
app.use(expressMiddleware({tracer, serviceName:"front-end"}), zipkinProxy(endpoints.loginUrl));
//const zipkinRest = rest.wrap(restInterceptor, {tracer, serviceName: 'frontend_login',remoteServiceName: 'user-container'});

    app.get("/login", function(req, res, next) {
        console.log("Received login request");

tracer.local('login request', () =>
